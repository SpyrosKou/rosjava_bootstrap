 ...
 */
public interface Ros2ServiceResponseInterface extends Ros2Interface {
   /**
   ...
   public default Ros2InterfaceCategory interfaceCategory(){
      return Ros2InterfaceCategory.SERVICE_RESPONSE;
   }

   @JsonIgnore
   @Override
   Ros2ServiceDefinition topLevelDefinition();
}
